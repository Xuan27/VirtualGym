...
public class AzureServices : MonoBehaviour
{
    ...
    private const string userDirectory = "DM";
    ...
    public async Task DownloadTrainingSettings(string filename)
    {
        ...
        Debug.Log(DownloadCloudFile.Name);
        ...
        Debug.Log(azureFileContent.Length);
    ...
    public async Task UploadTrainingInfo(string trainingType)
    {
        ...
        ErrorUploadCloudFile = dirUser.GetFileReference("Vertical" + ErrorFileName + ".txt");
        BoxUploadCloudFile = dirUser.GetFileReference("Vertical" + BoxPosFileName + ".txt");
        PathUploadCloudFile = dirUser.GetFileReference("Vertical" + PathPosFileName + ".txt");
        WindowErrorUploadCloudFile = dirUser.GetFileReference( "Vertical" + WindowErrorFileName + ".txt");
